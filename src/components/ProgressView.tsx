...
const progressCopy: Record<LanguageCode, Record<string, string>> = {
  de: {
    ...
    b1: '🚀 Erste Schritte', bd1: 'Etappe 1 vollständig abgeschlossen', b2: '🎯 Nischen-Meister', bd2: 'Nische & Zielgruppe erfolgreich definiert', b3: '🛠️ System-Bauer', bd3: 'Landingpage & Domain verknüpft', b4: '📩 Mail-Pionier', bd4: 'E-Mail-Kampagne & Autoresponder aktiviert', b5: '⚡ Traffic-Maschine', bd5: 'Organische Traffic-Quellen aufgebaut', b6: '🏆 Online Entrepreneur', bd6: 'Alle 7 Etappen gemeistert & System automatisiert'
  },
  en: {
  ...
  pl: {
    ...
    b1: '🚀 Pierwsze kroki', bd1: 'Etap 1 ukończony w całości', b2: '🎯 Mistrz niszy', bd2: 'Nisza i grupa docelowa zostały określone', b3: '🛠️ Budowniczy systemu', bd3: 'Strona docelowa i domena połączone', b4: '📩 Pionier e-mail', bd4: 'Kampania e-mail i autoresponder aktywowane', b5: '⚡ Maszyna ruchu', bd5: 'Zbudowano organiczne źródła ruchu', b6: '🏆 Przedsiębiorca online', bd6: 'Wszystkie 7 etapów ukończone, system zautomatyzowany'
  }
};
